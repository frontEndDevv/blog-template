...
db.define_table('the_page',
               ...
               Field('created_by', 'reference auth_user'),
                Field('category',requires=IS_IN_SET(['category1','category2','category3','category4','category5']), default='1'),
               Field('featured_image', 'upload'),
               format='%(title)s')

db.define_table('carousel',
               Field('image','upload'),
                Field('category',requires=IS_IN_SET(['category1','category2','category3','category4','category5'])),
               )
